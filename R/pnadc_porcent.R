...
#' porcent PNADc
#'
#' @description Creates PNADc percent tables for one or more variables. Tables can be generated in \R or exported using the "export" option
...
#' @param path Path to the directory where the Design was created using the "pnadc_download" function.
