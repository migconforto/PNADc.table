...
<div style="text-align: justify">
* **Ano**:
<br/> O ano que deseja baixar. Deve ser um número entre 2012 e o ano atual. Não aceita um vetor de anos. Todas as demais funções pedirão Ano como argumento
* **Quartil**:
...
* **path**:
<br/> path do diretorio local aonde estão os arquivos da PNADc ou aonde deseja salvar o Design. Caso não seja escolhido um path, os dados serão criado no disco local na pasta usuário do disco rígido local.
...
#Todos os designs seguem o mesmo padrão de nomenclatura: 'Design_PNADc_ano_quartil'
