...
<br/> Now let's export the previous tables. To do so, just use the **export** argument and select one of the formats between "pdf" and "png".
```{r}
...
#Export the graphic in .png format to the user's default directory.
```
<div style="text-align: justify">
...
#Export the graph in .pdf format to the user's default directory.
pnadc_graph(~V403312, ~UF, 2019, 1, calculation = "mean", path = "C:/Data_PNADc", classifier = "V403312", export = "png")
#Export the graphic in .png format to the user's default directory.
```
